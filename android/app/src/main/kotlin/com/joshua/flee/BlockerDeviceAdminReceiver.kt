...
class BlockerDeviceAdminReceiver : DeviceAdminReceiver() {
    ...
    override fun onEnabled(context: Context, intent: Intent) {
        ...
        Toast.makeText(context, "flee Uninstall Guard Activated", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onDisableRequested(context: Context, intent: Intent): CharSequence? {
        ...
        return "Warning: Deactivating flee Uninstall Guard will disable bypass timers and expose your device to distractions. A delay timer may be active."
    }
